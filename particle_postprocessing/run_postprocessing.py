...
def get_mode_and_reset_trigger():
    ...
    rc_input = pd.read_csv(
        '../Flight_Test_Data_24_09_21/flightlogs/log_2021-9-24_ikura_autonomous_soaring_input_rc_0.csv', usecols=[13])
...
log_data = pd.read_csv('../Flight_Test_Data_24_09_21/flightlogs/log_24-Sep-2021.csv')
...
sio.savemat('../Flight_Test_Data_24_09_21/postprocessing_results/Flight_Test_24_09_filter_result.mat', filter_data)
