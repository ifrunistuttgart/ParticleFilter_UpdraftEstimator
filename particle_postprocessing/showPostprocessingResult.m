...
load('./Flight_Test_24_09/postprocessing_results/Flight_Test_24_09_filter_result.mat');
...
time_annotation = annotation('textbox',[.15 .5 .3 .41],'String',sprintf('t=%3d',1),'FitBoxToText','on');
